...
data class FilledTriangleLineEnd(val arrowLineLength: Double = 30.0, val arrowAngle: Double = Math.PI/6): ALineEnd {
    ...
    override fun paint(gc: GraphicsContext, p: APoint, angle: Angle, style: LineStyle, t: AffineTransformation, zoom: Zoom) {
        ...
        gc.fillPolygon(doubleArrayOf(end0.x, tip.x, end1.x, end0.x), doubleArrayOf(end0.y, tip.y, end1.y, end0.y), 4);
    }
}
