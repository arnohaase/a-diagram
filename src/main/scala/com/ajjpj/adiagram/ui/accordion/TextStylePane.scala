...
/**
  * @author arno
  */
class TextStylePane(ctrl: ADiagramController)(implicit digest: Digest) extends Pane {
 ...
 //TODO bind
 ctrl.styleRepository.textStyles.foreach(ts => root.getChildren.add(new TreeItem(ts)))
 }
